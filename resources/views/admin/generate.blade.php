    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse border border-gray-200 overflow-hidden">
            <thead class="bg-gray-100 border-b border-gray-200">
                <tr>
                    <th class="border-b border-gray-200 p-4 text-sm font-bold text-gray-700">Id Kode</th>
                    <th class="border-b border-gray-200 p-4 text-sm font-bold text-gray-700">Kode</th>
                    <th class="border-b border-gray-200 p-4 text-sm font-bold text-gray-700">Status</th>
                    <th class="border-b border-gray-200 p-4 text-sm font-bold text-gray-700">Waktu Dibuat</th>
            ...
            <tbody class="divide-y divide-gray-100 bg-white">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    <td class="p-4 text-sm text-gray-800 font-medium">{{ $data->id }}</td>
                    <td class="p-4 text-sm text-gray-600">{{ $data->code }}</td>
                    <td class="p-4 text-xs text-gray-500 font-mono max-w-xs truncate"">
                        {{ $data->is_used }}
                    </td>
