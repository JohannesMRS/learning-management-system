...
<section class = "w-235 bg-gray-50 shadow-[0px_1px_5px_1px_rgba(0,0,0,0.2)]">
    <div class = "flex justify-center gap-10 mt-10">
        <div class = "w-50 h-30 shadow-[1px_1px_10px_2px_rgba(0,0,0,0.1)] rounded p-4 ">
            <p class = "mb-2">Total User</p>
            <p class = "text-4xl text-center">{{ $jumlahData }}</p>
        </div>
        <div class = "w-50 h-30 shadow-[1px_1px_10px_2px_rgba(0,0,0,0.1)] rounded p-4 ">
            <p class = "mb-2">Total Generate Code</p>
            <p class = "text-4xl text-center">{{ $jumlahDataGenerate }}</p>
        </div>
    </div>

    <table class = "table-auto mx-auto mt-10 w-11/12 text-center">
        <tr class = "border text-gray-600 text-sm">
    ...
    <table class = "table-auto mx-auto mt-10 w-11/12 text-center">
        <tr class = "border text-gray-600">
            ...
            <th class = "border border-gray-300 p-2 bg-gray-200">Kode</th>
        </tr>
        @foreach($datas as $data)
        <tr class = "hover:bg-gray-100 text-gray-500 font-medium text-sm">
